...
Deno.test("day-04 stage1", () => {
  assertEquals(stage1(testData), 4512);
  assertEquals(stage1(data), 63424);
});

Deno.test("day-04 stage2", () => {
  assertEquals(stage2(testData), 1924);
  assertEquals(stage2(data), 23541);
});
